import pytest
from doctor.serializers.doctor_specialization_serializer import (
    DoctorSpecializationSerializer,
)
from doctor.models import DoctorSpecialization
...
@pytest.mark.django_db
def test_deserialization(factory_doctor_specialization_fixture):
