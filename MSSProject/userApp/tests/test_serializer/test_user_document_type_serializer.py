import pytest
from userApp.serializers.user_serializer import DocumentTypeSerializer
from userApp.models import UserDocumentType


@pytest.mark.django_db
def test_serialize(user_document_type_fixture):
    serializer = DocumentTypeSerializer(data=user_document_type_fixture)
...
def test_deserialize(factory_user_document_type_fixture):
    serializer = DocumentTypeSerializer(instance=factory_user_document_type_fixture)
